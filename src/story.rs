...
fn render(context: Context, graphics: &mut GlGraphics, glyph_cache: &mut GlyphCache) {
    ...
    const LINES: [ColoredText; 20] = [
        ColoredText {
            ...
            text: "The stars snap back into place, jolting your neck forward.",
        },
        ColoredText {
            color: NARRATOR_COLOR,
            text: "Panicking, you check your ship’s readouts. This can’t be the right system.",
        },
        ColoredText {
            color: KARA_COLOR,
        ...
        ColoredText {
            color: NARRATOR_COLOR,
            text: "A piece of twisted metal screeches off your ship’s shields.",
        },
        ColoredText {
            color: KARA_COLOR,
        ...
        ColoredText {
            color: JACK_COLOR,
            text: "\"Kara, what happened here? Where’s the fleet?\"",
        },
        ColoredText {
            color: NARRATOR_COLOR,
            text: "A lifeless expanse of debris is all that surrounds you in every direction.",
        },
        ColoredText {
            color: KARA_COLOR,
            text: "\"--- ambush. --- --- tried to --- long range transmitter --- --- warn ---\"",
        },
        ColoredText {
            color: JACK_COLOR,
        ...
        ColoredText {
            color: NARRATOR_COLOR,
            text: "The debris thickens, tightening its grip around you.",
        },
        ColoredText {
            color: KARA_COLOR,
            text: "\"Shields --- percent.  Jack, --- --- last Ranger.\"",
        },
        ColoredText {
            color: KARA_COLOR,
            text: "\"--- must relay the --- for as long as possible to --- the others.\"",
        },
        ColoredText {
            color: JACK_COLOR,
        ...
        ColoredText {
            color: NARRATOR_COLOR,
            text: "Heat shoots up your spine as you thrust your engines to full.",
        },
        ColoredText {
            color: KARA_COLOR,
            text: "\"Shields --- percent.  Diverting remaining --- ---\"",
        },
        ColoredText {
            color: JACK_COLOR,
        ...
        ColoredText {
            color: KARA_COLOR,
            text: "\"--- Delta-Three --- signing off.  Jack, ... Jack, I ---\"",
        },
        ColoredText {
            color: KARA_COLOR,
            text: "\"...\"",
    ...
    for (index, line) in LINES.iter().enumerate() {
        ...
        text(line.color,
             ...
             glyph_cache,
             context.transform
                 .trans(LEFT_INDENT, STARTING_LINE_OFFSET + (index as f64 * NEW_LINE_OFFSET)),
             graphics);
    }
}
